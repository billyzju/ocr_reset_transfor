...
class Encoder(nn.Module):
    ...
    def forward(self, src_seq, src_pos, return_attns=False):
        """
			src_seq  [batch_size, len, dim]
			src_pos  [batch_size, len] 
		"""
...
class Decoder(nn.Module):
    ...
    def forward(self, tgt_seq, tgt_pos, src_pos, enc_output, return_attns=False):
        ...
        tgt_pos [batch_size, max_len]
        src_pos [batch_size, len_fe]
        enc_output [batch_size, len_fe, dim]
     	"""
        ...
        dec_enc_attn_mask = get_attn_key_pad_mask(seq_k=src_pos, seq_q=tgt_seq)
...
class Transformer(nn.Module):
    ...
    def __init__(
            self,
            len_encoder, n_tgt_vocab, len_max_seq,
